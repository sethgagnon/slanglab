-- First, check what plan values are allowed and update them
-- Update the plan constraint to allow new plan types
...
-- Create unique constraint for user_id and month_year (if not exists)
DO $$ 
BEGIN
  IF NOT EXISTS (
